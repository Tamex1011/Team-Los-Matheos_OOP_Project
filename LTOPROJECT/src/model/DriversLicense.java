...
/**
 * DriversLicense class representing a driver's license.
 * 
 * This demonstrates:
 * - Encapsulation (Module 2): Private fields with getters
 * - Association (Module 1): Has a list of Violations (one-to-many relationship)
 */
public class DriversLicense implements Recordable {
    ...
    public Date getBirthDate() { 
        return new Date(birthDate.getTime()); // Return copy for encapsulation
    }
    
    public List<Violation> getViolations() { 
        return new ArrayList<>(violations); // Return copy for encapsulation
    }
